...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train Combat Apex Agent")
    ...
    run_training("combat", args.scenario, args.phase, args.timesteps, not args.no_headless, args.run_name)
