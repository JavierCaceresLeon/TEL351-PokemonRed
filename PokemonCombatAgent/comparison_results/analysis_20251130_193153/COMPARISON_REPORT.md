...
**Fecha:** 2025-11-30 21:22:33  
**Estado inicial:** `generated_battle_states\clean_pewter_gym.state`  
...
|---------|--------------|--------------|------------|---------|
| **Reward Promedio** | 0.18 | 0.10 | -0.08 | ✅ Baseline |
| **Steps Promedio** | 605 | 46 | 559 | ✅ Baseline (más eficiente) |
| **HP Dealt** | 9.60 | 0.50 | -9.10 | ✅ Baseline |
| **HP Taken** | 6.90 | 2.10 | 4.80 | ✅ Combat (menor daño) |
| **Win Rate** | 50.0% | 0.0% | -50.0% | ✅ Baseline |
...
**Baseline PPO:**
- Entra en batallas en **10/10 episodios** (100%)
- Promedio de **46 steps** por episodio (30x más eficiente)
- Win rate: **0.0%**
...
Los siguientes gráficos están disponibles en `comparison_results\analysis_20251130_193153/`:
