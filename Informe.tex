...
\usepackage{graphicx}
% Rutas de recursos (imágenes/tablas) del informe
\graphicspath{{informe_visuals/}{assets/}{./}}
\usepackage{siunitx}
\usepackage{float}
\usepackage{natbib}
\usepackage{setspace}
...
\title{
    ...
    % Logo institucional disponible en la carpeta assets del repositorio
    \includegraphics[width=4.5cm]{sblogo.png}\\[2mm]
...
% Tablas y figuras generadas automáticamente en informe_visuals/
...
% Tabla comparativa de búsqueda (incluye Tiempo (s))
...
% Comparación agregada (tabla y figuras maestro)
\input{informe_visuals/master_comparison_table.tex}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{master_tiempo_comparacion.png}
